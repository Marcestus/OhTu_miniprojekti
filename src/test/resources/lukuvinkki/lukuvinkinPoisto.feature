Feature: Ohjelman kayttajana voin poistaa lukuvinkin
    ...
    Scenario: kayttaja voi poistaa lukuvinkin hakemalla oikean otsikon perusteella
        ...
        Then  ohjelman tulostus sisaltaa "Lukuvinkin poistaminen onnistui" tekstin ja lukuvinkin oikea tiedot "otsikkoTesti" ja "https://www.google.com" 
    ...
    Scenario: kayttaja voi poistaa lukuvinkin hakemalla oikean url perusteella
        ...
        And   komento poisto otsikolla valittu
        And   lukuvinkin poistoon annettu url "urlPerusteella" ja poisto vahvistus "k"
        Then  ohjelman tulostus sisaltaa "Lukuvinkin poistaminen onnistui" tekstin ja lukuvinkin oikea tiedot "urlPerusteella" ja "https://www.facebook.com"
    ...
    Scenario: kayttaja voi aloittaa poiston ja perua sen
        ...
        Then  ohjelman tulostus sisaltaa "Lukuvinkkiä ei poistettu." tekstin